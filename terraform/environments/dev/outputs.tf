...
output "media_bucket_endpoint" {
  description = "S3-compatible endpoint for media bucket"
...
#   value       = module.app_loadbalancer.public_ip
# }
# 
# output "loadbalancer_dns" {
#   description = "DNS entry for the load balancer"
#   value       = module.app_loadbalancer.dns_entry
# }
...
# Sensitive outputs for Kubernetes secrets
